...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-12 py-2 z-10 bg-gradient-to-b from-black flex flex-col md:flex-row justify-between cursor-pointer">
      ...
      {user && (
        <div className='flex p-4 justify-between'>
          ...
          <button onClick={handleSignOut} className='p-1 font-bold text-white'>
            (Sign Out)
          </button>
        </div>
      )
